...
export default function WelcomePage() 
{
    return <section className="text-center">
        ...
        <article className="text-secondary mt-auto pb-3">
            <p>
                <span>by <a className='text-reset fw-bold text-decoration-none' target="_blank" href="https://nicholasmagi.it">Nicholas Magi</a> —— &lt;<span className='font-monospace'>nicholas.magi24[at]gmail.com</span>&gt;</span><br/>
